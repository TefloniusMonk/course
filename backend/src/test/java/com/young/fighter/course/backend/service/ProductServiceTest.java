...
//    @Test
//    void shouldUpdate() {
//        ProductView productView = productService.save(productViews.get(0)).block();
...
//    @Test
//    void shouldDelete() {
//        Product product = productRepository.save(modelMapper.map(productViews.get(0), Product.class)).block();
...
//    @Test
//    void shouldGet() {
//        Product product = productRepository.save(productList.get(0)).block();
//        ProductView productView = productService.findById(product.getProductId()).block();
...
//        List<ProductView> actualViews = productService.findAll().collectList().block();
