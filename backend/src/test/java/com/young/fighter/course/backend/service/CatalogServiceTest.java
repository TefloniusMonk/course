...
//    @Test
//    void shouldSave() {
//        CatalogView returned = catalogService.save(catalogView).block();
//        List<Catalog> actual = catalogRepository.findAll().collectList().block();
...
//    @Test
//    void shouldUpdate() {
//        catalogView = catalogService.save(catalogView).block();
...
//    @Test
//    void shouldDelete() {
//        Catalog saved = catalogRepository.save(catalog).block();
...
//    void shouldGetById() {
//        Catalog saved = catalogRepository.save(catalog).block();
//        CatalogView actual = catalogService.findById(saved.getCatalogId()).block();
...
//        catalogRepository.save(getCatalog(products));
//        catalogRepository.save(getCatalog(products));
//        List<CatalogView> actual = catalogService.findAll().collectList().block();
