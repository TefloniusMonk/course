...
//
//    @PostMapping("/sign-up")
//    public DeferredResult<UserView> save(@RequestBody @Valid UserView view) {
//        return new DeferredResult<UserView>(10L, userService.save(view));
//    }
//
//    @PostMapping("/auth")
//    public DeferredResult<String> auth(@RequestBody @Valid JwtRequest request) {
